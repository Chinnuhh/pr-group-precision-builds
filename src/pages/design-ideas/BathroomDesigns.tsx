...
const BathroomDesigns = () => {
  ...
  const handleGetQuote = () => {
    const message = "Hi! I'm interested in getting a quote for bathroom designs. Can you help me with the details?"
    window.open(`https://wa.me/918886663807?text=${encodeURIComponent(message)}`, '_blank')
  }

  const designs = [
    { image: "photo-1620626011761-996317b8d101", title: "Modern Bathroom" },
    { image: "photo-1584622650111-993a426fbf0a", title: "Luxury Bath" },
    { image: "photo-1605370445919-838d190e8e1b", title: "Compact Bathroom" },
    { image: "photo-1618221195710-dd6b41faaea6", title: "Spa-Style Bathroom" }
  ]
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-gradient-to-br from-blue-50 to-slate-100">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h1 className="text-5xl font-bold text-slate-900 mb-6">Bathroom Designs</h1>
          <p className="text-xl text-slate-600 max-w-3xl mx-auto mb-8">
            Create your perfect bathroom sanctuary with our innovative designs and premium fixtures.
          </p>
