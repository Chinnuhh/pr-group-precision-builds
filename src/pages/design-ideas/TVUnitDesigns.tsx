...
const TVUnitDesigns = () => {
  ...
  const handleGetQuote = () => {
    const message = "Hi! I'm interested in getting a quote for TV unit designs. Can you help me with the details?"
    window.open(`https://wa.me/918886663807?text=${encodeURIComponent(message)}`, '_blank')
  }

  const designs = [
    { image: "photo-1586023492125-27b2c045efd7", title: "Wall Mounted TV Unit" },
    { image: "photo-1560448204-603b3fc33ddc", title: "Entertainment Center" },
    { image: "photo-1616486338812-3dadae4b4ace", title: "Modern TV Console" },
    { image: "photo-1505693416388-ac5ce068fe85", title: "Built-in TV Wall" }
  ]
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-gradient-to-br from-blue-50 to-slate-100">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h1 className="text-5xl font-bold text-slate-900 mb-6">TV Unit Designs</h1>
          <p className="text-xl text-slate-600 max-w-3xl mx-auto mb-8">
            Stylish and functional TV units that enhance your entertainment experience.
          </p>
